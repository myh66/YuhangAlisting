...
const messages: Record<Language, Record<string, string>> = {
  "zh-CN": {
    ...
    "settings.app.closeAction": "关闭窗口时",
    "settings.close.ask": "每次询问",
    "settings.close.minimize": "最小化到托盘",
    "settings.close.exit": "直接退出程序",
    ...
    "mount.updatedNeedsRemount": "配置已保存；该挂载已先卸载，请重新挂载后资源管理器名称才会更新。",
    ...
    "mount.action.refreshExplorer": "刷新资源管理器",
    "mount.explorer.refreshed": "资源管理器已刷新。",
    "mount.title": "挂载配置",
    ...
    "service.uptime": "运行时间",
    "service.url": "访问地址",
    "app.close.title": "关闭 YuhangAlisting？",
    "app.close.content": "请选择最小化到托盘继续后台运行，或退出程序。",
    "app.close.remember": "记住我的选择",
  ...
  "en-US": {
    ...
    "settings.toggle.saved": "Option saved.",
    ...
    "settings.app.closeAction": "When closing the window",
    "settings.close.ask": "Ask every time",
    "settings.close.minimize": "Minimize to tray",
    "settings.close.exit": "Exit the app",
    ...
    "mount.updatedNeedsRemount": "Configuration saved. The running mount was unmounted; mount it again to refresh the Explorer/Finder display name.",
    ...
    "mount.action.refreshExplorer": "Refresh Explorer",
    "mount.explorer.refreshed": "Explorer refreshed.",
    ...
    "service.url": "URL",
    "app.close.title": "Close YuhangAlisting?",
    "app.close.content": "Minimize to the tray to keep it running, or exit the app.",
    "app.close.remember": "Remember my choice",
